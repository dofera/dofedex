class eval(org).utils.SimpleDateFormatter
{
	...
	static var MONTH_NAMES = {en:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_EN,fr:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_FR,de:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_DE,es:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_ES,pt:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_PT,nl:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_NL,it:eval(org).utils.SimpleDateFormatter.MONTH_NAMES_IT};
	...
	static var DAY_NAMES = {en:eval(org).utils.SimpleDateFormatter.DAY_NAMES_EN,fr:eval(org).utils.SimpleDateFormatter.DAY_NAMES_FR,de:eval(org).utils.SimpleDateFormatter.DAY_NAMES_DE,es:eval(org).utils.SimpleDateFormatter.DAY_NAMES_ES,pt:eval(org).utils.SimpleDateFormatter.DAY_NAMES_PT,nl:eval(org).utils.SimpleDateFormatter.DAY_NAMES_NL,it:eval(org).utils.SimpleDateFormatter.DAY_NAMES_IT};
	...
	static function formatDate(date, §\x0e\x05§, §\x0b\x1b§)
	{
		...
		var17.M = var10;
		var17.MM = eval(org).utils.SimpleDateFormatter.LZ(var10);
		var17.MMM = eval(org).utils.SimpleDateFormatter.MONTH_NAMES[var4][var10 - 1];
		var17.NNN = eval(org).utils.SimpleDateFormatter.MONTH_NAMES[var4][var10 + 11];
		var17.d = var11;
		var17.dd = eval(org).utils.SimpleDateFormatter.LZ(var11);
		var17.E = eval(org).utils.SimpleDateFormatter.DAY_NAMES[var4][var12 + 7];
		var17.EE = eval(org).utils.SimpleDateFormatter.DAY_NAMES[var4][var12];
		var17.H = var13;
		var17.HH = eval(org).utils.SimpleDateFormatter.LZ(var13);
		if(var13 == 0)
		{
			var17.h = 12;
		}
		...
		var17.hh = eval(org).utils.SimpleDateFormatter.LZ(var17.h);
		if(var13 > 11)
		{
			var17.K = var13 - 12;
		}
		...
		var17.k = var13 + 1;
		var17.KK = eval(org).utils.SimpleDateFormatter.LZ(var17.K);
		var17.kk = eval(org).utils.SimpleDateFormatter.LZ(var17.k);
		if(var13 > 11)
		{
			var17.a = "PM";
		...
		var17.m = var14;
		var17.mm = eval(org).utils.SimpleDateFormatter.LZ(var14);
		var17.s = var15;
		var17.ss = eval(org).utils.SimpleDateFormatter.LZ(var15);
		var17.i = var16;
		var17.ii = eval(org).utils.SimpleDateFormatter.LZ(var16);
	...
	{
		var var5 = eval(org).utils.SimpleDateFormatter.getDateFromFormat(var2,var3,var4);
		if(var5 == 0)
		{
			return false;
		}
	...
	{
		var var8 = eval(org).utils.SimpleDateFormatter.getDateFromFormat(var2,var3,var4);
		var var9 = eval(org).utils.SimpleDateFormatter.getDateFromFormat(var5,var6,var7);
		if(var8 == 0 || var9 == 0)
		{
			return -1;
		}
		...
		while(true)
		{
			if(var6 < var3.length)
			{
				...
				if(var8 == "yyyy" || (var8 == "yy" || var8 == "y"))
				{
					...
					var13 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var10,var11);
					if(var13 == null)
					{
						return null;
					}
				...
				else if(var8 == "MMM" || var8 == "NNN")
				{
					var14 = 0;
					var var21 = 0;
					while(var21 < eval(org).utils.SimpleDateFormatter.MONTH_NAMES[var4].length)
					{
						var var22 = eval(org).utils.SimpleDateFormatter.MONTH_NAMES[var4][var21];
				...
				{
					var var23 = 0;
					while(var23 < eval(org).utils.SimpleDateFormatter.DAY_NAMES[var4].length)
					{
						var var24 = eval(org).utils.SimpleDateFormatter.DAY_NAMES[var4][var23];
				...
				{
					var14 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
				...
				{
					var15 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
				...
				{
					var16 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
				...
				{
					var17 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
				...
				{
					var18 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
				...
				else
				{
					if(var8 == "ii" || var8 == "i")
					{
						var19 = eval(org).utils.SimpleDateFormatter._getInt(var2,var5,var8.length,2);
	...
	static function _getInt(var2, var3, var4, var5)
	{
		...
		while(var6 >= var4)
		{
			...
			if(eval(org).utils.SimpleDateFormatter._isInteger(var7))
			{
				return var7;
			}
			var6 = var6 - 1;
