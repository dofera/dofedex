class ank.utils.Sequencer extends Object
{
	...
	{
		if(!ank.utils.Sequencer._oLocalCache[var2])
		{
			ank.utils.Sequencer._oLocalCache[var2] = new ank.utils.({name:var2,localPath:var3,secure:var4});
		}
		return ank.utils.Sequencer._oLocalCache[var2];
	}
	static function getRemote(var2, var3, var4, var5)
	{
		if(!ank.utils.Sequencer._oRemoteCache[var2])
		{
			ank.utils.Sequencer._oRemoteCache[var2] = new ank.utils.({name:var2,remotePath:var3,persistence:var4,secure:var5});
		}
		return ank.utils.Sequencer._oRemoteCache[var2];
	}
