class ank.utils.PatternDecoder
{
	...
	static function getDescription(§\x1e\r\x02§, §\x1e\x02§)
	{
	...
	static function combine(§\x1e\f\x17§, §\x0e\x02§, §\x1e\x11\x17§)
	{
		ank.utils.Extensions.addExtensions();
		var var5 = var2.split("");
		var var6 = new Object();
	...
	static function replace(§\x1e\r\x18§, §\x1e\x0f\r§)
	{
		var var4 = var2.split("##");
		var var5 = 1;
	...
	static function replaceStr(§\x1e\r\x18§, §\x1e\x0e\n§, §\x1e\x0e\x10§)
	{
		var var5 = var2.split(var3);
		return var5.join(var4);
	}
	static function decodeDescription(§\x1d\n§, §\x1e\x02§)
	{
		var var4 = 0;
		var var5 = new String();
		var var6 = var2.length;
		for(; var4 < var6; var4 = var4 + 1)
		{
			var5 = var2[var4];
			if((var var0 = var5) !== "#")
			{
	...
	static function decodeCombine(§\x1d\n§, §\x1e\x18\x15§)
	{
		var var4 = 0;
		var var5 = new String();
		var var6 = var2.length;
	...
	static function find(§\x1c§, §\x0f\x03§)
	{
