class ank.utils.MouseEvents extends Object
{
	var _nTimeModerator = 1;
	function MouseEvents(timeout)
	{
		super();
	...
	function clear(var2)
	{
		...
		ank.utils.ExtendedArray.removeTimer(this,"sequencer");
	}
	...
	function execute(var2)
	{
		...
		while(var3)
		{
			if(this._aActions.length > 0)
			{
				...
				{
					var3 = false;
					ank.utils.ExtendedArray.setTimer(var4.object,"sequencer",this,this.onActionTimeOut,var4.duration == undefined?this._nTimeout:var4.duration * this._nTimeModerator,[var4.id]);
				}
			}
			else
			{
	...
	function onActionEnd(var2, var3)
	{
		...
		{
			ank.utils.ExtendedArray.removeTimer(this._aActions[0].object,"sequencer");
		}
