class ank.utils.ExtendedObject
{
	...
	static function getDescription(var2, var3)
	{
		...
		var var4 = var2.split("");
		var var5 = ank.utils.ExtendedObject.decodeDescription(var4,var3).join("");
		return var5;
	}
	static function combine(var2, var3, var4)
	{
		...
		var6.p = !var4;
		var6.s = var4;
		var var7 = ank.utils.ExtendedObject.decodeCombine(var5,var6).join("");
		return var7;
	}
	static function replace(var2, var3)
	{
		...
		while(var5 < var4.length)
		{
			...
			var4[var5] = ank.utils.ExtendedObject.getDescription(var3,var6);
			var5 = var5 + 2;
		}
		return var4.join("");
	}
		...
		while(var4 < var6)
		{
			...
			switch(var5)
			{
				...
				case "~":
					...
					break;
				case "{":
					var var9 = ank.utils.ExtendedObject.find(var2.slice(var4),"}");
					var var10 = ank.utils.ExtendedObject.decodeDescription(var2.slice(var4 + 1,var4 + var9),var3).join("");
				...
				default:
					...
					var var11 = ank.utils.ExtendedObject.find(var2.slice(var4),"]");
		...
		while(var4 < var6)
		{
			...
			switch(var5)
			{
				case "~":
					...
					break;
				case "{":
					var var8 = ank.utils.ExtendedObject.find(var2.slice(var4),"}");
					var var9 = ank.utils.ExtendedObject.decodeCombine(var2.slice(var4 + 1,var4 + var8),var3).join("");
