class ank.utils.Md5
{
	...
	{
		var var4 = ank.utils.Md5.removeAndGetLastWord(var3);
		var var5 = var4.lastWord;
		var3 = var4.leftCmd;
		var5 = var5.toLowerCase();
		var var6 = ank.utils.Md5.getStringsStartWith(var2,var5);
		if(var6.length > 1)
		{
			var var7 = "";
			var var8 = 0;
			...
			return ank.utils.Md5.autoCompletionRecurcive(var6,var3,var5 + var7);
		}
		if(var6.length != 0)
		{
	...
	static function autoCompletionRecurcive(var2, var3, var4)
	{
		...
		var var5 = ank.utils.Md5.getStringsStartWith(var2,var4);
		if(var5.length > 1 && var5.length == var2.length)
		{
			...
			return ank.utils.Md5.autoCompletionRecurcive(var5,var3,var4 + var6);
		}
		if(var5.length != 0)
		{
