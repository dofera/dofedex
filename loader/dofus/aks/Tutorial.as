class dofus.aks.Tutorial extends dofus.aks.Handler
{
	...
	function onGameBegin()
	{
		...
		var2.addAction(false,this.api.sounds,this.api.sounds.stopAllSounds);
		if(!this.api.config.isStreaming)
		{
			var2.addAction(true,this.api.ui,this.api.ui.loadUIComponent,["Cinematic","Cinematic",{file:(!this.api.config.isStreaming?dofus.aks.Tutorial.INTRO_CINEMATIC_PATH:dofus.aks.Tutorial.INTRO_CINEMATIC_PATH_LIGHT),sequencer:var2},{bUltimateOnTop:true}]);
		}
		var2.addAction(false,this.api.ui,this.api.ui.loadUIComponent,["AskGameBegin","AskGameBegin",undefined,{bAlwaysOnTop:true}]);
		var2.addAction(false,this.api.sounds,this.api.sounds.playMusic,[dofus.aks.Tutorial.NOOB_AREA_MUSIC_ID,true]);
