class dofus.managers.TutorialManager extends dofus.utils.ApiElement
{
	...
	function executeBloc(var2)
	{
		...
		if((var var0 = var2.type) !== dofus.datacenter.TutorialBloc.TYPE_ACTION)
		{
			switch(null)
			{
				...
				case dofus.datacenter.TutorialBloc.TYPE_IF:
					...
					if(var41)
					{
						this._oSequencer.addAction(false,this,this.callNextBloc,[var2.nextBlocTrueID]);
					}
					else
					{
						this._oSequencer.addAction(false,this,this.callNextBloc,[var2.nextBlocFalseID]);
					}
		...
		else
		{
			...
			if((var0 = var2.actionCode) !== "VAR_ADD")
			{
				loop4:
				switch(null)
				{
					case "VAR_SET":
						this._oSequencer.addAction(false,this,this.setToVariable,var2.params);
						break;
					case "CHAT":
						this._oSequencer.addAction(false,this.api.kernel,this.api.kernel.showMessage,[undefined,var2.params[0],var2.params[1]]);
						break;
					case "GFX_CLEAN_MAP":
						this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.cleanMap,[undefined,true]);
						break;
					case "GFX_SELECT":
						this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.select,[var2.params[0],var2.params[1]]);
						break;
					case "GFX_UNSELECT":
						this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.unSelect,[var2.params[0],var2.params[1]]);
						break;
					default:
						switch(null)
						{
							case "GFX_ALPHA":
								this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setSpriteAlpha,[var2.params[0],var2.params[1]]);
								break loop4;
							case "GFX_GRID":
							...
							case "GFX_ADD_INDICATOR":
								...
								this._oSequencer.addAction(false,this.api.ui,this.api.ui.loadUIComponent,["Indicator","Indicator",{coordinates:[var9,var10],offset:var2.params[1],rotate:false},{bAlwaysOnTop:true}]);
								break loop4;
							case "GFX_ADD_PLAYER_SPRITE":
								var var11 = this.api.datacenter.Player.data;
								this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.addSprite,[var11.id,var11]);
								break loop4;
							default:
								switch(null)
								{
									case "GFX_ADD_SPRITE":
										...
										this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.addSprite,[var12.id,var12]);
										break loop4;
									case "GFX_REMOVE_SPRITE":
										this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.removeSprite,[var2.params[0],false]);
										break loop4;
									case "GFX_MOVE_SPRITE":
										...
										var var15 = ank.battlefield.utils.Pathfinding.pathFind(this.api.gfx.mapHandler,var14.cellNum,var2.params[1],{bAllDirections:false,bIgnoreSprites:true,bCellNumOnly:true,bWithBeginCellNum:true});
										if(var15 != null)
										{
									...
									case "GFX_ADD_SPRITE_BUBBLE":
										...
										this._oSequencer.addAction(true,this.api.gfx,this.api.gfx.removeSpriteBubble,[var16],200);
										this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.addSpriteBubble,[var16,var2.params[1]]);
										break loop4;
									default:
										switch(null)
										{
											...
											case "GFX_SPRITE_DIR":
												...
												this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setSpriteDirection,[var17,var2.params[1]]);
												break loop4;
											case "GFX_SPRITE_POS":
												var var18 = this.getSpriteIDFromData(var2.params[0]);
												this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setSpritePosition,[var18,var2.params[1]]);
												break loop4;
											case "GFX_SPRITE_VISUALEFFECT":
												...
												this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.addVisualEffectOnSprite,[var19,var20,var2.params[2],var2.params[4]]);
												break loop4;
											case "GFX_SPRITE_ANIM":
												var var21 = this.getSpriteIDFromData(var2.params[0]);
												this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setSpriteAnim,[var21,var2.params[1]]);
												break loop4;
											default:
												switch(null)
												{
													case "GFX_SPRITE_EXEC_FUNCTION":
														...
														this._oSequencer.addAction(false,var23,var24,var2.params[2]);
														break loop4;
													case "GFX_SPRITE_SET_PROPERTY":
														...
														this._oSequencer.addAction(false,this,this.setObjectPropertyValue,[var26,var2.params[1],var2.params[2]]);
														break loop4;
													case "GFX_DRAW_ZONE":
														this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.drawZone,var2.params);
														break loop4;
													...
													case "GFX_ADD_POINTER_SHAPE":
														this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.addPointerShape,var2.params);
														break loop4;
													default:
														switch(null)
														{
															...
															case "GFX_DRAW_POINTER":
																this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.drawPointer,var2.params);
																break loop4;
															case "GFX_OBJECT2_INTERACTIVE":
																this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setObject2Interactive,[var2.params[0],var2.params[1],1]);
																break loop4;
															case "INTERAC_SET":
																this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setInteraction,[ank.battlefield.Constants[var2.params[0]]]);
																break loop4;
															default:
																switch(null)
																{
																	case "INTERAC_SET_ONCELLS":
																		this._oSequencer.addAction(false,this.api.gfx,this.api.gfx.setInteractionOnCells,[var2.params[0],ank.battlefield.Constants[var2.params[1]]]);
																		break loop4;
																	case "UI_ADD_INDICATOR":
																		...
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.unloadUIComponent,["Indicator"]);
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.loadUIComponent,["Indicator","Indicator",{coordinates:[var32,var33],offset:var35},{bAlwaysOnTop:true}]);
																		break loop4;
																	case "UI_REMOVE_INDICATOR":
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.unloadUIComponent,["Indicator"]);
																		break loop4;
																	case "UI_OPEN":
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.loadUIComponent,[var2.params[0],var2.params[0],var2.params[1],var2.params[2]]);
																		break loop4;
																	case "UI_OPEN_AUTOHIDE":
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.loadUIAutoHideComponent,[var2.params[0],var2.params[0],var2.params[1],var2.params[2]]);
																		break loop4;
																	case "UI_CLOSE":
																		this._oSequencer.addAction(false,this.api.ui,this.api.ui.unloadUIComponent,[var2.params[0]]);
																		break loop4;
																	default:
																		switch(null)
																		{
																			case "UI_EXEC_FUNCTION":
																				...
																				this._oSequencer.addAction(false,var36,var37,var2.params[2]);
																				break loop4;
																			case "ADD_SPELL":
																				var var38 = new dofus.datacenter.(var2.params[0],var2.params[1],var2.params[2]);
																				this._oSequencer.addAction(false,this.api.datacenter.Player,this.api.datacenter.Player.updateSpellPosition,[var38]);
																				break loop4;
																			case "SET_SPELLS":
																				this._oSequencer.addAction(false,this.api.network.Spells,this.api.network.Spells.onList,[var2.params.join(";")]);
																				break loop4;
																			case "REMOVE_SPELL":
																				this._oSequencer.addAction(false,this.api.datacenter.Player,this.api.datacenter.Player.removeSpell,var2.params);
																				break loop4;
																			default:
																				if(var0 !== "END")
																				{
																				...
																				this._oSequencer.addAction(false,this,this.terminate,var2.params);
																				if(!this._oSequencer.isPlaying())
																				{
																					this._oSequencer.execute(true);
																				}
			...
			{
				this._oSequencer.addAction(false,this,this.addToVariable,var2.params);
			}
			this._oSequencer.addAction(false,this,this.callNextBloc,[var2.nextBlocID]);
			if(!this._oSequencer.isPlaying())
			{
				this._oSequencer.execute(true);
			}
	...
	function setObjectPropertyValue(var2, var3, var4)
	{
		if(var2 == undefined)
		{
	...
	function getSpriteIDFromData(var2)
	{
	...
	function setToVariable(var2, var3)
	{
		var2 = this.extractVarName(var2);
		this._oVars[var2] = var3;
	}
	function addToVariable(var2, var3)
	{
		var2 = this.extractVarName(var2);
	...
	function onWaitingCase(var2)
	{
		...
		if(var5 != undefined)
		{
			if((var var0 = var5.code) !== "CELL_RELEASE")
			{
				loop2:
				switch(null)
				{
