		...
		switch(loc2.target._name)
		{
			...
			case "_btnValidate":
				...
				else
				{
					...
					{
						var loc3 = this.gapi.loadUIComponent("AskYesNo","AskYesNoBuy",{title:this.api.lang.getText("MOUNTPARK_PURCHASE"),text:this.api.lang.getText("DO_U_BUY_MOUNTPARK",[this._oMountPark.price])});
