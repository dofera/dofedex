class dofus.datacenter.SecureCraftExchange extends dofus.datacenter.Exchange
{
	...
	function SecureCraftExchange(loc3)
	{
		super();
	...
	function __set__payKama(loc2)
	{
		this._nPayKama = loc2;
		this.dispatchEvent({type:"payKamaChange",value:loc2});
	...
	function __set__payIfSuccessKama(loc2)
	{
		this._nPayIfSuccessKama = loc2;
		this.dispatchEvent({type:"payIfSuccessKamaChange",value:loc2});
