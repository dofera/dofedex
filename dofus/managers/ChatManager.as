class dofus.managers.ChatManager extends dofus.utils.ApiElement
{
	...
	function addText(var2, var3, var4, var5)
	{
		...
		if((var var0 = var3) !== dofus.Constants.MSG_CHAT_COLOR)
		{
			...
			switch(null)
			{
				...
				case dofus.Constants.THINK_CHAT_COLOR:
					...
					break;
				default:
					if(var0 !== dofus.Constants.GROUP_CHAT_COLOR)
					{
						switch(null)
						{
							...
							case dofus.Constants.INFO_CHAT_COLOR:
								...
								break loop0;
							default:
								if(var0 !== dofus.Constants.ERROR_CHAT_COLOR)
								{
									switch(null)
									{
										...
										case dofus.Constants.PVP_CHAT_COLOR:
											...
											break loop0;
										default:
											if(var0 !== dofus.Constants.TRADE_CHAT_COLOR)
											{
												switch(null)
												{
		...
		if(var9)
		{
			...
			var2 = this.applyInputCensorship(var2);
		}
		if(var8 && this.api.kernel.NightManager.time.length)
		{
			var6 = "[" + this.api.kernel.NightManager.time + "] ";
		}
		this._aMessages.push({textStyleLeft:"<font color=\"#" + var3 + "\"><br />",text:var2,textStyleRight:"</font>",type:var7,uniqId:var5,timestamp:var6,lf:false});
		...
		while(var5 < dofus.managers.ChatManager.MAX_VISIBLE && var6 >= 0)
		{
			...
			if(this._aVisibleTypes[var7.type] == true)
			{
				...
				if(!var7.htmlSyntaxChecked)
				{
					...
					var7.lf = !var8.v || var7.lf;
					var7.text = var8.t;
					var7.htmlSyntaxChecked = true;
				}
				if(this.api.kernel.OptionsManager.getOption("TimestampInChat"))
				{
					var4 = (!var7.lf?"":"<br/>") + var7.textStyleLeft + var7.timestamp + var7.text + var7.textStyleRight + var4;
				}
				else
				{
					var4 = (!var7.lf?"":"<br/>") + var7.textStyleLeft + var7.text + var7.textStyleRight + var4;
				}
			}
			var6 = var6 - 1;
		}
	...
	static function safeHtml(var2)
	{
		...
		var var7 = 0;
		var var8 = 0;
		while(var6.indexOf("<") > -1 && var7++ < dofus.managers.ChatManager.HTML_NB_PASS_MAX)
		{
			var var9 = var6.indexOf("<");
			var var10 = var6.indexOf(">",var9) + 1;
			var var11 = var6.substring(var9,var10);
			var var12 = var11.indexOf("/") == 1;
			var var13 = var11.indexOf("/") == var11.length - 2;
			var var14 = !var12?var11.substring(1,var11.length - 1):var11.substring(2,var11.length - 1);
			var14 = var14.substring(0,var14.indexOf(" ") <= -1?var14.length:var14.indexOf(" "));
			var5[var8] = {c:var12,b:var14};
			if(var13)
			{
				var5[var8 = var8 + 1] = {c:!var12,b:var14};
			}
			var6 = var6.substring(var10);
			var8 = var8 + 1;
		}
		var var15 = 0;
		while(var15 < var5.length)
		{
			var var16 = var5[var15];
			if(var16.c)
			{
				if(var4[var16.b] == undefined || var4[var16.b] == 0)
				{
					var3 = false;
				}
				else
				{
					var4[var16.b] = var4[var16.b] - 1;
				}
			}
			else
			{
				if(var4[var16.b] == undefined)
				{
					var4[var16.b] = 0;
				}
				var4[var16.b] = var4[var16.b] + 1;
		...
		if(var3)
		{
			return {v:true,t:var2};
		}
		return {v:false,t:var2.split("<").join("&lt;").split(">").join("&gt;")};
	}
